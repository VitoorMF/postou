// Tom de voz da marca: a lista de opções (chips da UI) e os descritores ricos
// que entram no prompt. Mandar só a palavra ("próximo") dá pouco pro modelo —
// o descritor diz, em concreto, pronome/formalidade/emoji/ritmo.
//
// ⚠️ TONE_GUIDES é ESPELHADO em supabase/functions/generate-pack/tone.ts
// (runtime Deno não importa daqui). Se mudar um, mude o outro.
